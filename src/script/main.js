...
$('#productSelector .radioBtns').click(function(){
    ...
    console.log('prodcuctType' ,productType);
...
function trimDuration(mixRange, maxRange, interval) {
    ...
    // for (var i = 24; i <= maxRange; i += 6) {
    //    $('.durationSelector').append(" <option value='" + i + "'>" + i + " mdr. " + " </option>");
    //    $('.durationSelector').val(getCurrentDuration);
    // }
